...
describe Soap::V1::PeopleController do
  ...
  describe "index service" do
    ...
    context "Authentication failure" do
      it "should raise HTTP 401 error" do
        expect { @client.call(:index, message: {"page" => "1", "hbx_id" => "177772", "user_token" => "zUzBsoTSKPbvXCQsB4Ky00"}) }.to raise_error(Savon::HTTPError) { |e|  expect(e.http.code).to eq(401) }
        expect { @client.call(:index, message: {"page" => "1", "hbx_id" => "177772", "user_token" => ""}) }.to raise_error(Savon::HTTPError) { |e|  expect(e.http.code).to eq(401) }
      end
    end
    ...
    context "Missing hbx_id" do
      it "should raise HTTP 422 error" do
        ...
        expect { @client.call(:index, message: {"page" => "1", "hbx_id" => "", "user_token" => "zUzBsoTSKPbvXCQsB4Ky"}) }.to raise_error(Savon::HTTPError) { |e|  expect(e.http.code).to eq(422) }
  ...
  describe "show service" do
    ...
    context "Authentication failure" do
      it "should raise HTTP 401 error" do
        expect { @client.call(:show, message: {"id" => "53e69d73eb899ad9ca053ada", "user_token" => "zUzBsoTSKPbvXCQsB4Ky00"}) }.to raise_error(Savon::HTTPError) { |e|  expect(e.http.code).to eq(401) }
        expect { @client.call(:show, message: {"id" => "53e69d73eb899ad9ca053ada", "user_token" => ""}) }.to raise_error(Savon::HTTPError) { |e|  expect(e.http.code).to eq(401) }
    ...
    context "Missing hbx_id" do
      it "should raise HTTP 422 error" do
        ...
        expect { @client.call(:show, message: {"hbx_id" => "", "user_token" => "zUzBsoTSKPbvXCQsB4Ky"}) }.to raise_error(Savon::HTTPError) { |e|  expect(e.http.code).to eq(422) }
