...
describe Soap::V1::ApplicationGroupsController do
  ...
  describe "index service" do
    ...
    context "Authentication failure" do
      it "should raise HTTP 401 error" do
        expect { @client.call(:index, message: {"page" => "1", "ids" => ["5431b03feb899a49e0000004"], "user_token" => "zUzBsoTSKPbvXCQsB4Ky00"}) }.to raise_error(Savon::HTTPError) { |e| puts expect(e.http.code).to eq(401) }
        expect { @client.call(:index, message: {"page" => "1", "ids" => ["5431b03feb899a49e0000004"], "user_token" => ""}) }.to raise_error(Savon::HTTPError) { |e| puts expect(e.http.code).to eq(401) }
      end
    end
    ...
    context "Missing id" do
      it "should raise HTTP 422 error" do
        ...
        expect { @client.call(:index, message: {"page" => "1", "ids" => "", "user_token" => "zUzBsoTSKPbvXCQsB4Ky"}) }.to raise_error(Savon::HTTPError) { |e| puts expect(e.http.code).to eq(422) }
  ...
  describe "show service" do
    ...
    context "Authentication failure" do
      it "should raise HTTP 401 error" do
        expect { @client.call(:show, message: {"id" => "5431b03feb899a49e0000004", "user_token" => "zUzBsoTSKPbvXCQsB4Ky00"}) }.to raise_error(Savon::HTTPError) { |e| puts expect(e.http.code).to eq(401) }
        expect { @client.call(:show, message: {"id" => "5431b03feb899a49e0000004", "user_token" => ""}) }.to raise_error(Savon::HTTPError) { |e| puts expect(e.http.code).to eq(401) }
      end
    end
