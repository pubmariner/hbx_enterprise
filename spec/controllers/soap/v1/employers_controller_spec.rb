...
describe Soap::V1::EmployersController do
  ...
  describe "index service" do
    ...
    context "Authentication failure" do
      it "should raise HTTP 401 error" do
        expect { @client.call(:index, message: {"page" => "1", "hbx_id" => "100102", "fein"=>"536002558", "user_token" => "zUzBsoTSKPbvXCQsB4Ky00"}) }.to raise_error(Savon::HTTPError) { |e| expect(e.http.code).to eq(401) }
        expect { @client.call(:index, message: {"page" => "1", "hbx_id" => "100102", "fein"=>"536002558", "user_token" => ""}) }.to raise_error(Savon::HTTPError) { |e|  expect(e.http.code).to eq(401) }
      end
    end
  ...
  describe "show service" do
    ...
    context "Authentication failure" do
      it "should raise HTTP 401 error" do
        expect { @client.call(:show, message: {"id" => "53e6731deb899a460302a120", "user_token" => "zUzBsoTSKPbvXCQsB4Ky00"}) }.to raise_error(Savon::HTTPError) { |e|  expect(e.http.code).to eq(401) }
        expect { @client.call(:show, message: {"id" => "53e6731deb899a460302a120", "user_token" => ""}) }.to raise_error(Savon::HTTPError) { |e|  expect(e.http.code).to eq(401) }
