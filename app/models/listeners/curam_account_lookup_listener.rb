...
module Listeners
  class CuramAccountLookupListener < Amqp::Client
    def on_message(delivery_info, properties, payload)
      reply_to = properties.reply_to
      headers = (properties.headers || {})
      code, body = Proxies::SearchCuramUsers.new.request(headers.stringify_keys)
    ...
    def self.queue_name
      ...
      "#{ec.hbx_id}.#{ec.environment}.q.hbx_enterprise.curam_account_lookup"
    end
